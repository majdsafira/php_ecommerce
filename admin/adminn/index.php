...
<!--<img src="<?//php echo $user['user_img']; ?>" class="card-img-top" style="width: 150px; height: 150px; display: block; margin-left: auto; margin-right: auto;">-->
          <div class="card-body">
            <h5 class="card-title"><?php echo $admin['admin_name']?></h5>
            <h6 class="card-title"><?php echo $admin['admin_email']?></h6>
            <h6 class="card-text"><?php echo $admin['admin_password']?></h6>
            
            <form style="display: inline-block" method="post" action="./delete.php">
              <input type="hidden" name="id" value="<?php echo $admin['admin_id']; ?>">
              <button type="submit" id="<?php echo $admin['admin_id'];?>"
                class="btn btn-outline-danger">Delete</button>
            </form>
            <a href="./edit.php?id=<?php echo $admin['admin_id']?>" class="btn btn-outline-primary">Edit</a>
          </div>
        </div>
      </div>
